...
function PrivacyPage() {
  return (
    <div className="mx-auto max-w-3xl space-y-6 text-white/80">
      <h1 className="font-display text-3xl font-bold text-white">Chính sách bảo mật</h1>
      <p className="text-sm text-white/50">Cập nhật lần cuối: 2026</p>

      <section className="space-y-2">
        <h2 className="text-xl font-semibold text-white">1. Thông tin thu thập</h2>
      ...
      <section className="space-y-2">
        <h2 className="text-xl font-semibold text-white">2. Cookies & Session</h2>
        <p>movieCC dùng session cookie để duy trì đăng nhập. Không có tracking cookie bên thứ ba.</p>
      </section>

      <section className="space-y-2">
        <h2 className="text-xl font-semibold text-white">3. Chia sẻ dữ liệu</h2>
